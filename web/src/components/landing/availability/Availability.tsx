...
import {IAvailabilityReducer, setAvailability} from '../../../redux/slices/availability'
...
export const Availability = () => {
    ...
    const availability = useSelector(({ availability }: IAvailabilityReducer) => availability)
