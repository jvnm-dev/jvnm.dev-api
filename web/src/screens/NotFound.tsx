...
export const NotFound = () => (
  <Container>
    <Section column horizontallyCentered verticallyCentered mobilePadding>
      ...
      <Title small style={{ marginTop: '48px' }}>Where are you going?</Title>
      <Text margin centered>
        I am very sorry to say that there is nothing here... But maybe I will add something here just for you.
      </Text>
